...
import { UserOnlineMatchesItem } from "./UserOnlineMatchesItem";
import { UserSpeedMatchesItem } from "./UserSpeedMatchesItem";
import { UserQuickMatchesItem } from "./UserQuickMatchesItem";

export const UserQuickMatches = ({ user }) => {
