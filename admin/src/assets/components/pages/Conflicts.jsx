...
export const Conflicts = () => {
  ...
  useEffect(() => {
    ...
    fetcher(
      "/fetchMatches",
      { onlyConflict: true, status: menu, keyword: keyword },
      page,
      setPage,
      setMatches
    );
    ...
    <>
      <div className="p-2 rounded shadow-sm bg-white mx-2">
        <div className="p-2 bg-white rounded mb-3">
          <div className="mb-1">Manage Conflict Matches</div>
      ...
      <div className="">
        ...
        {matches.length < 1 && (
          <div className="text-center py-2">no macthes found</div>
        )}
      </div>
    </>
  );
