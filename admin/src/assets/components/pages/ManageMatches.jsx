    ...
    <>
      <div className="p-2 rounded shadow-sm bg-white mx-2">
        <div className="p-2 bg-white rounded mb-3">
          <div className="mb-1">Manage Manual Matches</div>
          <div className="d-flex gap-1 flex-wrap">
            <DashButton current={menu} action={handleMenu} text="all" />
            <DashButton current={menu} action={handleMenu} text="open" />
            ...
            <DashButton current={menu} action={handleMenu} text="conflicted" />
          </div>
