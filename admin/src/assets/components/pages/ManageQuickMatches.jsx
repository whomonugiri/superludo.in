...
import { UserSpeedMatchesItem } from "../elements/UserSpeedMatchesItem";
import { UserQuickMatchesItem } from "../elements/UserQuickMatchesItem";

export const ManageQuickMatches = () => {
    ...
    <>
      <div className="p-2 rounded shadow-sm bg-white mx-2">
        <div className="p-2 bg-white rounded mb-3">
          <div className="mb-1">Manage Quick Ludo Matches</div>
      ...
      <div className="">
        {matches.length > 0 && (
          <div className="d-flex flex-wrap">
            {matches.map((match) => (
              <UserQuickMatchesItem key={match._id} match={match} />
            ))}
          </div>
        )}
