...
export const PMatch = ({ match }) => {
  const { t } = useTranslation();

  return (
    <>
      {" "}
      <div className="rounded-2 bg-primary border my-3 animate__animated animate__backInLeft animate__fast">
        <div className="p-1 px-2 bg-overlay">
          ...
          <div className="d-flex justify-content-between align-items-center py-1">
            ...
            <div>
              <Link to="/match" className="text-decoration-none">
                <Button1
