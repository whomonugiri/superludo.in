...
import { TwoPlayer } from "./game/twoplayer/scenes/TwoPlayer";
import { AUTO, Scale, Game } from "phaser";
import { TwoPlayerWaiting } from "./game/twoplayer/scenes/TwoPlayerWaiting";
import { Splash } from "./game/twoplayer/scenes/Splash";
import { Loading } from "./game/twoplayer/scenes/Loading";
import { useNavigate, useParams } from "react-router";
import { io } from "socket.io-client";
import { CLASSIC_ONLINE_SERVER } from "./utils/constants";
...
const OnlineClassic = () => {
  ...
  useEffect(() => {
    ...
    if (!params.gameUid) navigate("/classic-online");
    ...
    socketRef.current = io(CLASSIC_ONLINE_SERVER, {
