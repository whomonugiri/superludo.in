...
import { TwoPlayer } from "./game/quickludo/scenes/TwoPlayer";
import { AUTO, Scale, Game } from "phaser";
import { TwoPlayerWaiting } from "./game/quickludo/scenes/TwoPlayerWaiting";
import { Splash } from "./game/quickludo/scenes/Splash";
import { Loading } from "./game/quickludo/scenes/Loading";
...
const QuickLudo = () => {
  ...
  useEffect(() => {
    ...
    if (!params.gameUid) navigate("/quickludo");
    ...
    socketRef.current = io(QUICK_LUDO_SERVER, {
